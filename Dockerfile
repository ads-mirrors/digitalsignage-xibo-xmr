...
# Install opcache and ensure its running for CLI
...
RUN chown -R nobody /opt/xmr && chmod 755 /entrypoint.sh && chmod +x /entrypoint.sh

# Start as root (entrypoint drops to nobody)
CMD ["/entrypoint.sh"]